export const unitOne = {
    slug: 'unidade-1',
    eyebrow: 'Unidade 1',
    title: 'Introdução às PICS no SUS: princípios e bases legais',
    bannerTitle: 'Unidade 1',
    bannerSubtitle: 'Introdução às PICS no SUS: princípios e bases legais',
    menuTitle: 'Conteúdo da Unidade 1',
    pages: [
        {
            title: 'O que são as Práticas Integrativas e Complementares em Saúde (PICS)',
            className: 'pagina-o-que-sao-as-pics',
            html: `<section class="conteudo-texto-imagem-flex unidade-1-introducao" aria-labelledby="unidade-1-pagina-1-titulo" aria-describedby="unidade-1-pagina-1-descricao">
                <div class="conteudo-texto-imagem-flex-card">
                    ...
                    <figure class="conteudo-texto-imagem-flex-imagem conteudo-figura unidade-1-figura unidade-1-figura--retrato" aria-labelledby="figura-8-unidade-1-titulo" aria-describedby="figura-8-unidade-1-subtitulo">
                        <p id="figura-8-unidade-1-titulo" class="conteudo-figura-titulo">
                            Figura 8 – Momento coletivo de relaxamento
                        </p>

                        <img loading="lazy" decoding="async" src="./assets/images/unidades/unidade-01/figura-01-unidade-01.webp" width="3024" height="4032" alt="Pessoas repousam sobre colchonetes enquanto uma facilitadora permanece sentada à frente do grupo.">

                        <figcaption id="figura-8-unidade-1-subtitulo" class="conteudo-figura-subtitulo">
                            Participantes repousam sobre colchonetes, acompanhados por uma facilitadora.
                        </figcaption>
                    </figure>
                </div>
            </section>
